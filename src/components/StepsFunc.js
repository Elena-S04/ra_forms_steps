...
export default function Steps() {
  ...
  const handleSubmit = (e) => {
    ...
    const newItem = {
      date: date.join("."),
      distance: Number(steps.distance),
    };
    ...
    <div className="container-steps">
      <form className="form-steps" onSubmit={handleSubmit}>
        <label className="label-steps">
          ...
          <input
            ...
            name="date"
            required
            pattern="[0-3]{1}[0-9]{1}.[0-1]{1}[0-9]{1}.[0-2]{1}[0-9]{1}"
            value={steps.date}
        ...
        <label className="label-steps">
          ...
          <input
            ...
            name="distance"
            required
            pattern="^0*(?:[1-9]*[.][0-9]*[.]?|100)$|^0*(?:[1-9][0-9]?|100)$"
      ...
      <div className="container-list">
        <div className="titles-list">
          <p className="title">Дата (ДД.ММ.ГГ)</p>
          <p className="title">Пройдено км</p>
          <p className="title">Действия</p>
        </div>
